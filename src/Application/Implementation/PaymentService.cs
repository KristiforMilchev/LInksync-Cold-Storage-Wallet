...
namespace SYNCWallet.Data
{
    public class PaymentService : IPaymentService
    {
        ...
        public async Task<TransactionResult> BeginTransaction()
        {
            ...
            {
                Console.WriteLine(e);
                Communication.PublishError("Transaction failed", $"failed sending transaction! /r/n {e.Message}");
        ...
        public async Task<bool> ValidateTransaction(string txHash)
        {
            ...
            {
                Console.WriteLine(e);
                Communication.PublishError("Validating transaction failed", e.Message);
            }
            return true;
        }
    }
