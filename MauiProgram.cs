...
public static class MauiProgram
{
    ...
    public static async Task<MauiApp> CreateMauiApp()
    {
        ...
        ActiveNetwork = new NetworkSettings();
        ActiveNetwork.Chainid = 97;
        ActiveNetwork.Endpoint = "https://data-seed-prebsc-1-s1.binance.org:8545/";

         Task.Run(() => ps.ValidateTransaction("0xc52b829d8cbceb5f5b063f7af0013c9029a7856da858c3257c1a3a2f68576d22"));
